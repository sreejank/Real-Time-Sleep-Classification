...
class CMFCVTReadDlg : public CDialog
{
// Construction
public:
	CMFCVTReadDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CMFCVTReadDlg)
	enum { IDD = IDD_MFCVTREAD_DIALOG };
		// NOTE: the ClassWizard will add data members here
	//}}AFX_DATA

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CMFCVTReadDlg)
	protected:
